...
SCHEMA_PATH = ROOT / "schemas" / "workspace-delta.v0.schema.json"
SAMPLE_PATH = ROOT / "examples" / "workspace" / "workspace-delta.sample.json"
...
@pytest.mark.parametrize(
    ...
    [
        ...
        "workspace_after_ref",
        "active_concepts_added",
        "active_concepts_removed",
        "constraints_added",
        "constraints_removed",
        "next_allowed_actions_added",
        "next_allowed_actions_removed",
...
def test_array_fields_must_be_arrays(field: str) -> None:
    schema = _load_schema()
    sample = _load_sample()
    # set the field to a non-array value (e.g., a string or boolean)
    sample[field] = "not_an_array_string"
